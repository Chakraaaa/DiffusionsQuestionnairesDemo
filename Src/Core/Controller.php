...
class Controller
{
    ...
    /**
     *  Initialise le controleur et efface les variables de SESSION sauf celles voulues par le controleur
     *
     *  Les variables maintenues en session par le controleur sont passés par l'array $arr_session
     *
     * @param array $arr_session
     */
    public function init(array $arr_session = NULL)
    {
        try {
     ...
     */
    public function showVue(array $vars_vue)
    {
        try {
