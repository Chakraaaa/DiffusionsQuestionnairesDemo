<form id="create-single-radio-list-form" name="create-single-radio-list-form" method="POST" action="<?=$urlCreateNewSingleRadio360List?>">
    <hr class="divider">
    <div class="columns">
    ...
    <div class="field is-grouped has-text-right">
        <div class="control">
            <button type="button" id="button-fermer-pop-up-create-single-radio360-list" class="button-fermer">Fermer</button>
        </div>
        <div class="control">
