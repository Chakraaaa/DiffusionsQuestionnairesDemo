...
<form id="edit-single-radio-text-form" name="edit-single-radio-text-form" method="POST" action="<?=$urlSavePopUpEditSingleRadio360Text?>">
    ...
    <div class="field is-grouped has-text-right">
        <div class="control">
            <button type="button" id="button-fermer-pop-up-edit-single-radio360-text" class="button-fermer">Fermer</button>
        </div>
        <div class="control">
