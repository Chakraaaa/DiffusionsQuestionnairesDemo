<form id="edit-single-question-prcc-form" name="edit-single-question-prcc-form" method="POST" action="<?=$urlSavePopUpEditSingleQuestionPrcc?>">
    ...
    <div class="field is-grouped has-text-right">
        <div class="control">
            <button type="button" id="button-fermer-pop-up-edit-single-question-prcc" class="button-fermer">Fermer</button>
        </div>
        <div class="control">
