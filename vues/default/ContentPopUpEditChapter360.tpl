 <form id="edit-chapter-form" name="edit-chapter-form" method="POST" action="<?=$urlSavePopUpEditChapter360?>">
        ...
        <div class="field is-grouped has-text-right">
            <div class="control">
                <button id="button-fermer-pop-up-edit-chapter360" type="button" class="button-fermer">Fermer</button>
            </div>
            <div class="control">
