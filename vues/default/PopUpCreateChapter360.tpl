<div>
    <form id="create-chapter-form" name="create-chapter-form" method="POST" action="<?=$urlCreateNewChapter360?>">
        <hr class="divider">
        ...
        <div class="field is-grouped has-text-right">
            <div class="control">
                <button id="button-fermer-pop-up-create-chapter360" type="button" class="button-fermer">Fermer</button>
            </div>
            <div class="control">
