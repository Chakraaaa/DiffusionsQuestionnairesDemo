...
<form id="edit-single-radio-list-form" name="edit-single-radio-list-form" method="POST" action="<?=$urlSavePopUpEditSingleRadio360List?>">
    ...
    <div class="field is-grouped has-text-right">
        <div class="control">
            <button type="button" id="button-fermer-pop-up-edit-single-radio360-list" class="button-fermer">Fermer</button>
        </div>
        <div class="control">
