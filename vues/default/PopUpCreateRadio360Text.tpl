<div>
    <form id="create-radio-text-form" name="create-radio-text-form" method="POST" action="<?=$urlCreateNewRadio360Text?>">
        <hr class="divider">
        ...
        <div class="field is-grouped has-text-right">
            <div class="control">
                <button type="button" id="button-fermer-pop-up-create-radio360-text" class="button-fermer">Fermer</button>
            </div>
            <div class="control">
